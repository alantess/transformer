...
if __name__ == '__main__':
    ...
    agent = Agent(env.observation_space.shape[0],env.action_set.shape[0],env,capacity=75000,nheads=4, batch_size=32,transformer_layers=12, eps_dec=3.5e-6, replace=10000, lr=0.00045, epsilon=0.6)
